...
class MarqueeRiskModel(RiskModel):
    ...
    def __init__(
        ...
        self.__type: RiskModelType = (
            type_
            if type_ and isinstance(type_, RiskModelType)
            else RiskModelType(type_)
        )
    ...
    def get_dates(
        ...
        event_type: RiskModelEventType = None,
    ) -> List[dt.date]:
    ...
    def get_calendar(
        ...
        **See also**
        ...
        if not start_date and not end_date:
            return calendar
        start_idx = (
            get_closest_date_index(start_date, calendar.business_dates, "after")
            if start_date
            else 0
        )
        end_idx = (
    ...
    def get_factor(
        self, name: str, start_date: dt.date = None, end_date: dt.date = None
    ) -> Factor:
        ...
        name_matches = [
            f
            for f in self.get_factor_data(
                start_date=start_date, end_date=end_date, format=ReturnFormat.JSON
            )
            if f["name"] == name
        ]
    ...
    def get_factor_data(
        ...
        :param category_filter: Filter the results to those having one of the specified categories.             Default is to return all results
        ...
        **See also**
        ...
        if factor_type == FactorType.Category:
            if factor_categories:
                raise ValueError(
                    "Category filter is not applicable while requesting the FactorType as Category"
                )
        ...
        if factor_type == FactorType.Factor:
            if "Aggregations" in set(factor_categories):
                raise ValueError(
                    "Aggregations should not be passed while requesting the FactorType as Factor"
                )
            factor_type_value = factor_type.value
            factor_data = [
                factor
                for factor in factor_data
                if factor.get("type") == factor_type_value
            ]
        if format == ReturnFormat.DATA_FRAME:
    ...
    def get_factor_returns_by_name(
        ...
        **See also**
        ...
        return self._get_factor_data_measure(
            Measure.Factor_Return, start_date, end_date, assets, True, factors, format
        )
    ...
    def _get_factor_data_measure(
        ...
        factor_data_df = build_factor_data_map(
            results, identifier, self.id, requested_measure, factors=factors
        )
        return (
            factor_data_df
            if format == ReturnFormat.DATA_FRAME
    ...
    def _get_asset_data_measure(
        ...
        measure_data = build_asset_data_map(
            results, assets.universe, requested_measure, {}
        )
        if format == ReturnFormat.DATA_FRAME:
    ...
    def get_universe_exposure(
        ...
        **See also**
        ...
        factor_exposure = build_asset_data_map(
            results, assets.universe, Measure.Universe_Factor_Exposure, factor_map
        )
        if format == ReturnFormat.DATA_FRAME:
    ...
    def get_specific_risk(
        ...
        **See also**
        ...
        return self._get_asset_data_measure(
            Measure.Specific_Risk, start_date, end_date, assets, format
        )
    ...
    def upload_data(
        ...
        target_universe_size = (
            0 if only_factor_data_present else get_universe_size(data)
        )
        make_partial_request = (
            target_universe_size > max_asset_batch_size or not full_data_present
        )
        if target_universe_size:
            logging.info(f"Target universe size for upload: {target_universe_size}")
        if make_partial_request:
            batch_and_upload_partial_data(
                self.id, data, max_asset_batch_size, aws_upload=aws_upload
            )
        else:
    ...
    @deprecation.deprecated(
        deprecated_in="0.9.42", details="Please use upload_data instead"
    )
    def upload_partial_data(
        self, data: Union[RiskModelData, dict], final_upload: bool = None
    ):
    ...
    def from_target(cls, model):
        ...
        return MarqueeRiskModel(
            ...
            if isinstance(model.coverage, CoverageType)
            else CoverageType(model.coverage),
            ...
            expected_update_time=dt.datetime.strptime(
                model.expected_update_time, "%H:%M:%S"
            ).time()
...
class FactorRiskModel(MarqueeRiskModel):
    ...
    ...                                       DataAssetsRequest(UniverseIdentifier.bbid, ['GS UN']))
        ...
        **See also**
        ...
        """
        return self._get_asset_data_measure(
            Measure.Total_Risk, start_date, end_date, assets, format
        )
    ...
    def get_historical_beta(
        ...
        **See also**
        ...
        """
        return self._get_asset_data_measure(
            Measure.Historical_Beta, start_date, end_date, assets, format
        )
    ...
    def get_predicted_beta(
        ...
        **See also**
        ...
        """
        return self._get_asset_data_measure(
            Measure.Predicted_Beta, start_date, end_date, assets, format
        )
    ...
    def get_global_predicted_beta(
        ...
        **See also**
        ...
        """
        return self._get_asset_data_measure(
            Measure.Global_Predicted_Beta, start_date, end_date, assets, format
        )
    ...
    def get_daily_return(
        ...
        **See also**
        ...
        """
        return self._get_asset_data_measure(
            Measure.Daily_Return, start_date, end_date, assets, format
        )
    ...
    def get_specific_return(
        ...
        **See also**
        ...
        """
        return self._get_asset_data_measure(
            Measure.Specific_Return, start_date, end_date, assets, format
        )
        ...
        **See also**
        ...
        try:
            requested_measure = (
                ...
                if not days
                else Measure[f"Bid_Ask_Spread_{days}d"]
            )
            return super()._get_asset_data_measure(
                requested_measure, start_date, end_date, assets, format
            )
        except KeyError:
            raise ValueError(
                f"Bid Ask Spread data is not available for the requested days: {days}"
            )
        ...
        **See also**
        ...
        try:
            requested_measure = (
                ...
                if not days
                else Measure[f"Trading_Volume_{days}d"]
            )
            return super()._get_asset_data_measure(
                requested_measure, start_date, end_date, assets, format
            )
            ...
            raise ValueError(
                f"Trading volume data is not available for the requested days: {days}"
            )
        ...
        **See also**
        ...
        try:
            requested_measure = (
                ...
                if not days
                else Measure[f"Traded_Value_{days}d"]
            )
            return super()._get_asset_data_measure(
                requested_measure, start_date, end_date, assets, format
            )
            ...
            raise ValueError(
                f"Traded Value data is not available for the requested days: {days}"
            )
        ...
        **See also**
        ...
        try:
            requested_measure = (
                ...
                if not days
                else Measure[f"Composite_Volume_{days}d"]
            )
            return super()._get_asset_data_measure(
                requested_measure, start_date, end_date, assets, format
            )
            ...
            raise ValueError(
                f"Composite Volume data is not available for the requested days: {days}"
            )
        ...
        **See also**
        ...
        try:
            requested_measure = (
                ...
                if not days
                else Measure[f"Composite_Value_{days}d"]
            )
            return super()._get_asset_data_measure(
                requested_measure, start_date, end_date, assets, format
            )
            ...
            raise ValueError(
                f"Composite Value data is not available for the requested days: {days}"
            )
    ...
    def get_issuer_market_cap(
        ...
        **See also**
        ...
        """
        return super()._get_asset_data_measure(
            Measure.Issuer_Market_Cap, start_date, end_date, assets, format
        )
    ...
    def get_asset_price(
        ...
        **See also**
        ...
        """
        return super()._get_asset_data_measure(
            Measure.Price, start_date, end_date, assets, format
        )
    ...
    def get_asset_capitalization(
        ...
        **See also**
        ...
        """
        return super()._get_asset_data_measure(
            Measure.Capitalization, start_date, end_date, assets, format
        )
    ...
    def get_currency(
        ...
        **See also**
        ...
        """
        return super()._get_asset_data_measure(
            Measure.Currency, start_date, end_date, assets, format
        )
    ...
    def get_unadjusted_specific_risk(
        ...
        **See also**
        ...
        """
        return super()._get_asset_data_measure(
            Measure.Unadjusted_Specific_Risk, start_date, end_date, assets, format
        )
    ...
    def get_dividend_yield(
        ...
        **See also**
        ...
        """
        return super()._get_asset_data_measure(
            Measure.Dividend_Yield, start_date, end_date, assets, format
        )
    ...
    def _build_covariance_matrix_measure(
        ...
        covariance_data = (
            ...
            if format == ReturnFormat.JSON
                ...
                results,
                covariance_matrix_key=measure_to_field_name_map[covariance_matrix_type],
            )
        )
    ...
    def get_covariance_matrix(
        ...
        **See also**
        ...
        return self._build_covariance_matrix_measure(
            Measure.Covariance_Matrix, start_date, end_date, assets, format
        )
    ...
    def get_risk_free_rate(
        ...
        **See also**
        ...
        return self._build_currency_rates_data(
            results, rates_key="riskFreeRate", currencies=currencies, format=format
        )
    ...
    def get_currency_exchange_rate(
        ...
        **See also**
        ...
        return self._build_currency_rates_data(
            results, rates_key="exchangeRate", currencies=currencies, format=format
        )
    ...
    def get_factor_volatility(
        ...
        **See also**
        ...
        if format == ReturnFormat.JSON and not get_factors_by_name and not factors:
            ...
            factor_volatility_df = build_factor_volatility_dataframe(
                results, get_factors_by_name, factors
            )
            return (
                factor_volatility_df
                if format == ReturnFormat.DATA_FRAME
                else factor_volatility_df.to_dict()
            )
    ...
    def get_estimation_universe_weights(
        ...
        """ Get estimation universe data for existing risk model
           ...
           **See also**
           ...
           """
        return self._get_asset_data_measure(
            Measure.Estimation_Universe_Weight, start_date, end_date, assets, format
        )
    ...
    def get_issuer_specific_covariance(
        ...
        **See also**
        ...
        isc_data = (
            isc
            if format == ReturnFormat.JSON
            else get_optional_data_as_dataframe(isc, "issuerSpecificCovariance")
        )
        return isc_data
    ...
    def get_asset_contribution_to_risk(
        ...
        **Examples**
        ...
        security = SecurityMaster.get_asset(
            asset_identifier, AssetIdentifier(asset_identifier_type.value.upper())
        )
        ...
        if len(series) == 0:
            raise MqValueError(
                f"{asset_identifier} has no end of day price available on {date.strftime('%Y-%m-%d')}"
            )
        ...
        risk_results = self.get_data(
            ...
            date,
            RiskModelDataAssetsRequest(
                identifier=asset_identifier_type, universe=[asset_identifier]
            ),
            limit_factors=True,
        )
        if len(risk_results["results"][0]["assetData"]["totalRisk"]) == 0:
            raise MqValueError(
                f"{asset_identifier} is not covered by {self.id} on {date.strftime('%Y-%m-%d')}"
            )
        ...
        exp = np.array(
            [factor_z_scores[key] * spot_price for key in factor_ids_in_order]
        )
        ...
        for i in range(0, len(mctr)):
            final_results.append(
                {
                    "Factor": factors[i]["factorName"]
                    if get_factors_by_name
                    else factors[i]["factorId"],
        ...
        final_results.append(
            {
                ...
                "Proportion of Risk (%)": (total_risk - annualized_factor_rmctr_sum)
                / total_risk
                * 100,
    ...
    def get_asset_factor_attribution(
        ...
        **Examples**
        ...
        if len(risk_results) < 2:
            raise MqValueError(
                "Attribution cannot be calculated with only one day of risk data"
            )
        ...
        for i in range(1, len(risk_results)):
            ...
            for factor_data in risk_results[i]["factorData"]:
                factor = (
                    factor_data["factorName"]
                    if get_factors_by_name
                    else factor_data["factorId"]
                )
                attribution_on_date[factor] = factor_data["factorReturn"]
                factor_id_to_name_map[factor_data["factorId"]] = factor_data[
                    "factorName"
                ]

            previous_factor_exposures = risk_results[i - 1]["assetData"][
                "factorExposure"
            ][0]
            for factor_id in previous_factor_exposures:
                factor = (
                    factor_id_to_name_map[factor_id]
                    if get_factors_by_name
                    else factor_id
                )
        ...
        return (
            pd.DataFrame(factor_attribution)
            if format == ReturnFormat.DATA_FRAME
            else factor_attribution
        )
...
class MacroRiskModel(MarqueeRiskModel):
    ...
    def get_universe_sensitivity(
        ...
        **See also**
        ...
        sensitivity_df = (
            ...
            if factor_type == FactorType.Factor
            else super().get_universe_exposure(
                start_date, end_date, assets, get_factors_by_name=get_factors_by_name
            )
        )
        ...
        factor_data = (
            factor_data.set_index("name")
            if get_factors_by_name
            else factor_data.set_index("identifier")
        )
        columns = (
            [
                (factor_data.loc[f, "factorCategory"], f)
                for f in sensitivity_df.columns.values
            ]
            if get_factors_by_name
            else [
                (factor_data.loc[f, "factorCategoryId"], f)
                for f in sensitivity_df.columns.values
            ]
        )
        sensitivity_df = sensitivity_df.set_axis(
            pd.MultiIndex.from_tuples(columns), axis=1
        )

        factor_categories = list(set(sensitivity_df.columns.get_level_values(0).values))
        factor_category_sens_df = pd.concat(
            [
                sensitivity_df[factor_category]
                .agg(np.sum, axis=1)
                .to_frame()
    ...
    def get_r_squared(
        ...
        **See also**
        ...
        return self._get_asset_data_measure(
            Measure.R_Squared, start_date, end_date, assets, format
        )
    ...
    def get_model_price(
        ...
        **See also**
        ...
        """
        return super()._get_asset_data_measure(
            Measure.Model_Price, start_date, end_date, assets, format
        )
