...
class RelativeDate:
    ...
    **Documentation**
    ...
    def __init__(self, rule: str, base_date: Optional[dt.date] = None):
        ...
        self.base_date = (
            self.base_date.date()
            if isinstance(self.base_date, (dt.datetime, pd.Timestamp))
            else self.base_date
        )
    ...
    def apply_rule(
        ...
        **kwargs,
        ...
        # dt.date and dt.datetime are immutable, so we can use direct assignment
        result = self.base_date
    ...
    **Examples**
    ...
    def __init__(
        ...
        if base_date:
            ...
            self.base_date = (
                pricing_date.date()
                if isinstance(pricing_date, (dt.datetime, pd.Timestamp))
                else pricing_date
            )
        else:
            self.base_date = dt.date.today()
