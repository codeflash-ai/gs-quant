...
def _backtest_engines():
    ...
    if not hasattr(_backtest_engines, "_engines"):
        _backtest_engines._engines = [GenericEngine(), PredefinedAssetEngine(), EquityVolEngine()]
    return _backtest_engines._engines.copy()
