...
def combine_risk_key(key_1: RiskKey, key_2: RiskKey) -> RiskKey:
    ...
    return RiskKey(key_1.provider if key_1.provider == key_2.provider else None,
                   key_1.date if key_1.date == key_2.date else None,
                   key_1.market if key_1.market == key_2.market else None,
                   key_1.params if key_1.params == key_2.params else None,
                   key_1.scenario if key_1.scenario == key_2.scenario else None,
                   key_1.risk_measure if key_1.risk_measure == key_2.risk_measure else None)
